  ...
  <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
    ...
    >
      <div className="p-8 border-b border-white/5 flex justify-between items-center bg-gradient-to-r from-purple-500/10 to-transparent">
        <div>
          <h2 className="text-xl font-black text-white tracking-tight uppercase">Invoice Details</h2>
          <p className="text-xs text-white/40 font-bold uppercase tracking-widest mt-1">Ref: {invoice.id}</p>
        </div>
      ...
      <div className="p-8 space-y-8 max-h-[60vh] overflow-y-auto no-scrollbar">
        <div className="grid grid-cols-2 gap-8">
          <div>
            <label className="text-[10px] font-black text-white/20 uppercase tracking-widest block mb-1">Patient</label>
            <p className="text-sm font-bold text-white">{invoice.patient}</p>
          </div>
          <div className="text-right">
            <label className="text-[10px] font-black text-white/20 uppercase tracking-widest block mb-1">Date</label>
            <p className="text-sm font-bold text-white">{invoice.date}</p>
          </div>
        </div>

        <div>
          <label className="text-[10px] font-black text-white/20 uppercase tracking-widest block mb-4">Services Rendered</label>
        ...
        <div className="pt-8 border-t border-white/5 space-y-2">
          ...
          <div className="flex justify-between items-center text-white/40">
            <span className="text-[10px] font-black uppercase tracking-widest">Tax (GST 18%)</span>
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      >
        <form onSubmit={handleSubmit}>
          <div className="p-8 border-b border-white/5 flex justify-between items-center bg-gradient-to-r from-purple-500/10 to-transparent">
            <h2 className="text-xl font-black text-white tracking-tight uppercase">New Invoice</h2>
          ...
          <div className="p-8 space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-white/20 uppercase tracking-widest">Patient Name</label>
              <input 
                value={patient}
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-white/20 uppercase tracking-widest">Primary Service</label>
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-white/20 uppercase tracking-widest">Base Amount (₹)</label>
              <input 
                type="number"
                value={amount}
          ...
          <div className="p-8 bg-white/[0.02] border-t border-white/5">
            <button type="submit" className="w-full py-4 bg-purple-500 hover:bg-purple-400 text-white rounded-xl text-[10px] font-black uppercase tracking-widest shadow-xl shadow-purple-900/20 transition-all">
              Execute Production Protocol (Save)
            </button>
          </div>
        </form>
      </motion.div>
